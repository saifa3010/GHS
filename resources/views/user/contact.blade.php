...
<div class="container-xxl py-5">
    <div class="container">
        <div class="row">
            ...
            <div style="margin-left:300px" class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                ...
                <form action="{{route("contact.send")}}" method="post">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <button class="btn btn-primary" style="height: 100%" type="submit">Send Message</button>
                        </div>
                    </div>
                </form>
            </div>
